...
jest.mock("@react-navigation/native", () => ({
  ...jest.requireActual<typeof reactNavigationNativeImport>(
...
type TestNavigationContainerProps = {
  initialState: reactNavigationNativeImport.InitialState;
};
...
const SearchStack =
  createPlatformStackNavigator<SearchFullscreenNavigatorParamList>();
...
describe("SearchPageNarrow", () => {
  ...
  it("SearchPageNarrow renders correctly", async () => {
    ...
    const searchAutocompleteInput = screen.getByTestId(
      "search-autocomplete-text-input",
