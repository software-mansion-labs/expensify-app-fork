import {expectEveryConfigToMatch, hidden, resetLog, runEveryConfig, runNestedActivity, spec, visible} from '../utils/ScreenActivityEffectTestUtils';

/**
 * Every test runs one scenario on the four configurations of ScreenActivityEffectTestUtils and compares the effect
 * calls commit by commit, with plain useEffect on a screen that stays live in the background as the baseline. The last
 * step of every scenario is the screen leaving the navigation stack, so each one also covers the teardown.
 */
