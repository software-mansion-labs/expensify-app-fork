...
describe('APITests', () => {
    test('All writes should be persisted while offline', () => {
        ...
        return Onyx.set(ONYXKEYS.NETWORK, {isOffline: true})
            .then(() => {
                ...
                void API.write<WriteCommand>('mock command' as WriteCommand, {param1: 'value1'} as ApiRequestCommandParameters[WriteCommand]);
                API.read<ReadCommand>('mock command' as ReadCommand, {param2: 'value2'} as unknown as ApiRequestCommandParameters[ReadCommand]);
                void API.write<WriteCommand>('mock command' as WriteCommand, {param3: 'value3'} as ApiRequestCommandParameters[WriteCommand]);
                return waitForBatchedUpdates();
            })
            .then(() => {
    ...
    test('Write requests should resume when we are online', () => {
        ...
        return void Onyx.multiSet({
            ...
            .then(() => {
                ...
                void API.write<WriteCommand>('mock command' as WriteCommand, {param1: 'value1'} as ApiRequestCommandParameters[WriteCommand]);
                void API.write<WriteCommand>('mock command' as WriteCommand, {param2: 'value2'} as ApiRequestCommandParameters[WriteCommand]);
                return waitForBatchedUpdates();
            })
            .then(() => {
                const persisted = PersistedRequests.getAll();
    ...
    test('Write request should not be cleared until a backend response occurs', () => {
        ...
        // Given we have some requests made while we're offline
        return void Onyx.set(ONYXKEYS.NETWORK, {isOffline: true})
            .then(() => {
                // When API Write commands are made
                void API.write<WriteCommand>('mock command' as WriteCommand, {param1: 'value1'} as ApiRequestCommandParameters[WriteCommand]);
                void API.write<WriteCommand>('mock command' as WriteCommand, {param2: 'value2'} as ApiRequestCommandParameters[WriteCommand]);
    ...
    test('Write request can trigger reauthentication for anything retryable', () => {
        ...
        void Onyx.merge(ONYXKEYS.CREDENTIALS, {autoGeneratedLogin: 'test', autoGeneratedPassword: 'passwd'});
        return (
            waitForBatchedUpdates()
                .then(() => Onyx.set(ONYXKEYS.NETWORK, {isOffline: true}))
                .then(() => {
                    void API.write<WriteCommand>('Mock' as WriteCommand, {param1: 'value1'} as ApiRequestCommandParameters[WriteCommand]);
                    return waitForBatchedUpdates();
                })
    ...
    test('several actions made while offline will get added in the order they are created', () => {
        ...
        return Onyx.multiSet({
            ...
            .then(() => {
                ...
                void API.write<WriteCommand>('MockCommand' as WriteCommand, {content: 'value1'} as ApiRequestCommandParameters[WriteCommand]);
                void API.write<WriteCommand>('MockCommand' as WriteCommand, {content: 'value2'} as ApiRequestCommandParameters[WriteCommand]);
                void API.write<WriteCommand>('MockCommand' as WriteCommand, {content: 'value3'} as ApiRequestCommandParameters[WriteCommand]);
                ...
                void API.write<WriteCommand>('MockCommand' as WriteCommand, {content: 'value4'} as ApiRequestCommandParameters[WriteCommand]);
                void API.write<WriteCommand>('MockCommand' as WriteCommand, {content: 'value5'} as ApiRequestCommandParameters[WriteCommand]);
                void API.write<WriteCommand>('MockCommand' as WriteCommand, {content: 'value6'} as ApiRequestCommandParameters[WriteCommand]);
    ...
    test('Sequential queue will succeed if triggered while reauthentication via main queue is in progress', () => {
        ...
        return Onyx.multiSet({
            ...
            .then(() => {
                void API.write('MockCommand' as WriteCommand, {});
    ...
    test('Write request will move directly to the SequentialQueue when we are online and block non-Write requests', () => {
        ...
        return Onyx.set(ONYXKEYS.NETWORK, {isOffline: false})
            .then(() => {
                ...
                void API.write('MockCommandOne' as WriteCommand, {});
                API.read('MockCommandTwo' as ReadCommand, null);
                void API.write('MockCommandThree' as WriteCommand, {});
    ...
    test('Read request should not stuck when SequentialQueue is paused and resumed', async () => {
        ...
        void API.write('MockWriteCommandOne' as WriteCommand, {});
        void API.write('MockWriteCommandTwo' as WriteCommand, {});
    ...
    test('duplicated write APIs with resolveDuplicationConflictAction conflict', () => {
        ...
        return Onyx.multiSet({
            ...
            .then(() => {
                ...
                void API.writeWithNoDuplicatesConflictAction('MockCommand' as WriteCommand, {content: 'value1'} as ApiRequestCommandParameters[WriteCommand]);
                void API.writeWithNoDuplicatesConflictAction('MockCommand' as WriteCommand, {content: 'value2'} as ApiRequestCommandParameters[WriteCommand]);
                void API.writeWithNoDuplicatesConflictAction('MockCommand' as WriteCommand, {content: 'value3'} as ApiRequestCommandParameters[WriteCommand]);
                return waitForBatchedUpdates();
            })
            .then(() => Onyx.set(ONYXKEYS.NETWORK, {isOffline: false}))
            .then(waitForBatchedUpdates)
    ...
    test('different write APIs with resolveDuplicationConflictAction conflict', () => {
        ...
        return Onyx.multiSet({
            ...
            .then(() => {
                ...
                void API.writeWithNoDuplicatesConflictAction('MockCommandOne' as WriteCommand, {content: 'value1'} as ApiRequestCommandParameters[WriteCommand]);
                void API.writeWithNoDuplicatesConflictAction('MockCommandTwo' as WriteCommand, {content: 'value2'} as ApiRequestCommandParameters[WriteCommand]);
                void API.writeWithNoDuplicatesConflictAction('MockCommandThree' as WriteCommand, {content: 'value3'} as ApiRequestCommandParameters[WriteCommand]);
                return waitForBatchedUpdates();
            })
            .then(() => Onyx.set(ONYXKEYS.NETWORK, {isOffline: false}))
            .then(waitForBatchedUpdates)
    ...
    test('duplicated write APIs with resolveEnableFeatureConflicts conflict and same policyID', () => {
        ...
        return Onyx.multiSet({
            ...
            .then(() => {
                ...
                void API.writeWithNoDuplicatesEnableFeatureConflicts(
