...
function ButtonText({text, numberOfLines = 1}: ButtonTextProps) {
    ...
    return (
        <Text
            ...
            style={[numberOfLines !== 1 && styles.breakAll, isLoading && styles.opacity0, styles.pointerEventsNone, styles.buttonText, sizeTextStyle, variantTextStyle]}
