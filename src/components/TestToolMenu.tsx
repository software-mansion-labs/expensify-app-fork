...
function TestToolMenu() {
    ...
    const isUsingStagingServer = activeServer === CONST.SERVER.STAGING;
            ...
            {!CONFIG.IS_USING_LOCAL_WEB && (
                ...
                >
                    <Switch
                        ...
                        isOn={isUsingStagingServer}
                        onToggle={() => setActiveServer(isUsingStagingServer ? CONST.SERVER.PRODUCTION : CONST.SERVER.STAGING)}
                    />
                </TestToolRow>
            )}
