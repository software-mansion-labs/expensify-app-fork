...
type LocaleContextProps = {
    ...
    toLocaleOrdinal: (number: number, writtenOrdinals?: boolean) => string;
...
function LocaleContextProvider({preferredLocale, currentUserPersonalDetails, children}: LocaleContextProviderProps) {
    ...
    const toLocaleOrdinal = useMemo<LocaleContextProps['toLocaleOrdinal']>(() => (number, writtenOrdinals) => LocaleDigitUtils.toLocaleOrdinal(locale, number, writtenOrdinals), [locale]);
