...
import { useChartInteractions, useChartLabelLayout, useChartLabelFormats, useChartColors } from '@components/Charts/hooks';
...
function BarChartContent({ data, title, titleIcon, isLoading, yAxisUnit, useSingleColor = false, onBarPress }: BarChartProps) {
    ...
    const checkIsOverBar = useCallback((args: HitTestArgs) => {
        'worklet';
