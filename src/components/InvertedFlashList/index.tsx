...
function InvertedFlashList<T>({onScroll: onScrollProp = () => {}, ...props}: InvertedFlashListProps<T>, ref: ForwardedRef<FlashList<T>>) {
...
InvertedFlashList.displayName = 'InvertedFlashList';

export default forwardRef(InvertedFlashList);
