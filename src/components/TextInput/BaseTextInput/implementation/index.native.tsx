                        ...
                        <View style={[styles.textInputAndIconContainer, styles.flex1, isMultiline && hasLabel && styles.textInputMultilineContainer, styles.pointerEventsBoxNone]}>
                            ...
                            <InputComponent
                                ref={(element: BaseTextInputRef | null): void => {
                                    const baseTextInputRef = isInLandscapeMode && !allowFocusInLandscape ? getLandscapeTextInputRefProxy(element) : element;
                                ...
                                {...inputProps}
                                autoFocus={isInLandscapeMode && !allowFocusInLandscape ? false : inputProps.autoFocus}
