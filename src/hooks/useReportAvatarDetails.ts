 ...
 */
function useReportAvatarDetails({iouReport, chatReport}: {iouReport: OnyxEntry<Report>; chatReport: OnyxEntry<Report>}): ReportAvatarDetails {
    ...
    const [action] = useOnyx(`${ONYXKEYS.COLLECTION.REPORT_ACTIONS}${iouReport?.parentReportID ?? chatReport?.reportID}`, {
