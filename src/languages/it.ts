    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            servers: {
                ...
                qa: {label: 'QA', description: 'Database separato. Accedere qui crea un account diverso'},
            },
            ...
            confirmServerChangeDescription: 'Passare a QA o uscirne effettua la disconnessione, perché QA è un database separato.',
        },
        security: 'Sicurezza',
        signOut: 'Esci',
