...
const CENTRAL_PANE_TO_RHP_MAPPING: Partial<Record<CentralPaneName, string[]>> = {
    ...
    [SCREENS.WORKSPACE.TAXES]: [SCREENS.WORKSPACE.TAXES_SETTINGS, SCREENS.WORKSPACE.TAXES_EDIT, SCREENS.WORKSPACE.TAXES_EDIT_NAME, SCREENS.WORKSPACE.TAXES_EDIT_VALUE],
};
