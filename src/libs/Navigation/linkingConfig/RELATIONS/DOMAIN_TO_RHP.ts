...
const DOMAIN_TO_RHP: Partial<Record<keyof DomainSplitNavigatorParamList, string[]>> = {
    ...
    [SCREENS.DOMAIN.MEMBERS]: [SCREENS.DOMAIN.MEMBER_DETAILS, SCREENS.DOMAIN.ADD_MEMBER, SCREENS.DOMAIN.MEMBERS_SETTINGS, SCREENS.DOMAIN.MEMBERS_SETTINGS_TWO_FACTOR_AUTH],
