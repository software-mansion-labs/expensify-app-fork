import type {SettingsScreenName} from '@libs/Navigation/types';
import SCREENS from '@src/SCREENS';

const SETTINGS_SPLIT_TO_RHP_MAPPING: Partial<Record<SettingsScreenName, string[]>> = {
...
export default SETTINGS_SPLIT_TO_RHP_MAPPING;
