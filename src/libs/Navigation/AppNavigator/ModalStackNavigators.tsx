...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.WORKSPACE.TAXES_EDIT]: () => require('../../../pages/workspace/taxes/WorkspaceTaxesEditPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.TAXES_EDIT_NAME]: () => require('../../../pages/workspace/taxes/NamePage').default as React.ComponentType,
    [SCREENS.WORKSPACE.TAXES_EDIT_VALUE]: () => require('../../../pages/workspace/taxes/ValuePage').default as React.ComponentType,
    [SCREENS.WORKSPACE.TAXES_SETTINGS]: () => require('../../../pages/workspace/taxes/WorkspaceTaxesSettingsPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.TAXES_SETTINGS_CUSTOM_TAX_NAME]: () => require('../../../pages/workspace/taxes/SettingsCustomTaxName').default as React.ComponentType,
    [SCREENS.WORKSPACE.TAXES_SETTINGS_FOREIGN_CURRENCY_DEFAULT]: () => require('../../../pages/workspace/taxes/SettingsForeignCurrency').default as React.ComponentType,
    [SCREENS.WORKSPACE.TAXES_SETTINGS_WORKSPACE_CURRENCY_DEFAULT]: () => require('../../../pages/workspace/taxes/SettingsWorkspaceCurrency').default as React.ComponentType,
