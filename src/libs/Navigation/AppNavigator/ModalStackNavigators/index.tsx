...
const ShareModalStackNavigator = createModalStackNavigator({
    [SCREENS.SHARE.ROOT]: () => require('../../../../pages/share/ShareRootPage') as React.ComponentType,
    [SCREENS.SHARE.MESSAGE]: () => require('../../../../pages/share/ShareComposeMessagePage') as React.ComponentType,
    [SCREENS.SHARE.SCAN_CONFIRM]: () => require('../../../../pages/iou/request/step/IOURequestStepConfirmation') as React.ComponentType,
});
