...
const OnboardingAccounting = lazyWithSuspense(() => import('@pages/OnboardingAccounting'));
const OnboardingEmployees = lazyWithSuspense(() => import('@pages/OnboardingEmployees'));
const OnboardingInterestedFeatures = lazyWithSuspense(() => import('@pages/OnboardingInterestedFeatures'));
const OnboardingPersonalDetails = lazyWithSuspense(() => import('@pages/OnboardingPersonalDetails'));
const OnboardingPrivateDomain = lazyWithSuspense(() => import('@pages/OnboardingPrivateDomain'));
const OnboardingPurpose = lazyWithSuspense(() => import('@pages/OnboardingPurpose'));
const OnboardingWorkEmail = lazyWithSuspense(() => import('@pages/OnboardingWorkEmail'));
const OnboardingWorkEmailValidation = lazyWithSuspense(() => import('@pages/OnboardingWorkEmailValidation'));
const OnboardingWorkspaceConfirmation = lazyWithSuspense(() => import('@pages/OnboardingWorkspaceConfirmation'));
const OnboardingWorkspaceCurrency = lazyWithSuspense(() => import('@pages/OnboardingWorkspaceCurrency'));
const OnboardingWorkspaceInvite = lazyWithSuspense(() => import('@pages/OnboardingWorkspaceInvite'));
const OnboardingWorkspaceOptional = lazyWithSuspense(() => import('@pages/OnboardingWorkspaceOptional'));
const OnboardingWorkspaces = lazyWithSuspense(() => import('@pages/OnboardingWorkspaces'));
