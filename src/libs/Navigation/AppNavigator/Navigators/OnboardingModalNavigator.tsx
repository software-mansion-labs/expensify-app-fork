...
const OnboardingAccounting = React.lazy(() => import('@pages/OnboardingAccounting'));
const OnboardingEmployees = React.lazy(() => import('@pages/OnboardingEmployees'));
const OnboardingInterestedFeatures = React.lazy(() => import('@pages/OnboardingInterestedFeatures'));
const OnboardingPersonalDetails = React.lazy(() => import('@pages/OnboardingPersonalDetails'));
const OnboardingPrivateDomain = React.lazy(() => import('@pages/OnboardingPrivateDomain'));
const OnboardingPurpose = React.lazy(() => import('@pages/OnboardingPurpose'));
const OnboardingWorkEmail = React.lazy(() => import('@pages/OnboardingWorkEmail'));
const OnboardingWorkEmailValidation = React.lazy(() => import('@pages/OnboardingWorkEmailValidation'));
const OnboardingWorkspaceConfirmation = React.lazy(() => import('@pages/OnboardingWorkspaceConfirmation'));
const OnboardingWorkspaceCurrency = React.lazy(() => import('@pages/OnboardingWorkspaceCurrency'));
const OnboardingWorkspaceInvite = React.lazy(() => import('@pages/OnboardingWorkspaceInvite'));
const OnboardingWorkspaceOptional = React.lazy(() => import('@pages/OnboardingWorkspaceOptional'));
const OnboardingWorkspaces = React.lazy(() => import('@pages/OnboardingWorkspaces'));
