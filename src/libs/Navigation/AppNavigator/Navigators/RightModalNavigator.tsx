...
import {Animated, InteractionManager, Pressable, View} from 'react-native';
...
import createTestCardStyleInterpolator from '@libs/Navigation/AppNavigator/createTestCardStyleInterpolator';
...
function RightModalNavigator({navigation, route}: RightModalNavigatorProps) {
    ...
    const screenOptions = useMemo(() => {
        ...
        if (isSafari()) {
            ...
            options.cardStyleInterpolator = (props: StackCardInterpolationProps) => customInterpolator(isSmallScreenWidth || isMediumScreenWidth, false, false, props);
        }

        const testInterpolator = createTestCardStyleInterpolator(styleUtils);
        options.cardStyleInterpolator = (props: StackCardInterpolationProps) => testInterpolator(isSmallScreenWidth, false, false, props);
        return options;
    }, [isMediumScreenWidth, isSmallScreenWidth, styleUtils, styles]);
    ...
    return (
        <NoDropZone>
            <Stack.Navigator
                screenOptions={{
                    ...screenOptions,
                    cardStyle: styles.RHPNavigatorContainer(false),
