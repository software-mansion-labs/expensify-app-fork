...
function peg$parse(input, options) {
  ...
  var peg$e69 = peg$literalExpectation("view", true);
  var peg$e70 = peg$literalExpectation("perDiem", true);
  ...
  var peg$e74 = peg$otherExpectation("operator");
  ...
  var peg$e81 = peg$otherExpectation("word");
  var peg$e82 = peg$classExpectation([" ", ",", "\t", "\n", "\r", "\xA0"], true, false);
  var peg$e83 = peg$otherExpectation("whitespace");
  var peg$e84 = peg$classExpectation([" ", "\t", "\r", "\n", "\xA0"], false, false);
  var peg$e85 = peg$otherExpectation("quote");
  ...
  var peg$e93 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"]], false, false);
  ...
  var peg$f57 = function() { return "eq"; };
  var peg$f58 = function() { return "neq"; };
  var peg$f59 = function() { return "gte"; };
  var peg$f60 = function() { return "gt"; };
  var peg$f61 = function() { return "lte"; };
  var peg$f62 = function() { return "lt"; };
  var peg$f63 = function(o) {
      if (nameOperator) {
        expectingNestedQuote = (o === "eq"); // Use simple parser if no valid operator is found
      }
      return o;
  };
  var peg$f64 = function(chars) { return chars.join("").trim(); };
  var peg$f65 = function() { return "and"; };
  var peg$f66 = function() { return expectingNestedQuote; };
  var peg$f67 = function(start, inner, end) { //handle no-breaking space
      return [...start, '"', ...inner, '"', ...end].join("");
    };
  var peg$f68 = function(start) {return "“"};
  var peg$f69 = function(start) {return "”"};
  var peg$f70 = function(start) {return "\""};
  var peg$f71 = function(start, inner, end) {
