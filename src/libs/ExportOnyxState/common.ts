...
const safeOnyxKeys = new Set<string>([
    ...
    // Lazy-Onyx POC: scoped-materializer version stamps — no user data.
    ONYXKEYS.DERIVED_SCOPED_META,
...
const onyxKeysToMaskFragileData = new Set<string>([
    ...
    // Lazy-Onyx POC: LHN attributes projection — carries computed report names, so mask it.
    ONYXKEYS.COLLECTION.DERIVED_REPORT_ATTRIBUTES,
