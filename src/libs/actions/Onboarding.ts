...
function clearPersonalDetailsDraft() {
    void Onyx.set(ONYXKEYS.FORMS.ONBOARDING_PERSONAL_DETAILS_FORM_DRAFT, null);
}
...
function setPersonalDetails(firstName: string, lastName: string) {
    void Onyx.merge(ONYXKEYS.FORMS.ONBOARDING_PERSONAL_DETAILS_FORM, {firstName, lastName});
}
...
function clearWorkspaceDetailsDraft() {
    void Onyx.set(ONYXKEYS.FORMS.ONBOARDING_WORKSPACE_DETAILS_FORM_DRAFT, null);
}
...
function setWorkspaceCurrency(currency: string) {
    void Onyx.merge(ONYXKEYS.FORMS.ONBOARDING_WORKSPACE_DETAILS_FORM_DRAFT, {currency});
}
