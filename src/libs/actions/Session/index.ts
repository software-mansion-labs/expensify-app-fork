...
function signOutAndRedirectToSignIn(
    ...
    // session. Without an auth token there is nothing to invalidate, and the LogOut is still routed and
    // sent — on a QA build that means awaiting the Cloudflare handshake and navigating the tab away from
    // whatever screen the person was still using.
