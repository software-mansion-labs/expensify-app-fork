...
type FileDownload = (url: string, fileName?: string, successMessage?: string, shouldOpenExternalLink?: boolean, formData?: FormData, requestType?: RequestType) => Promise<void>;
