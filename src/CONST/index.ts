...
const CONST = {
    ...
    TELEMETRY: {
        ...
        SPAN_SEARCH_SERVER_RESPONSE: 'ManualSearchServerResponse',
        ...
        // Search request timing and response-shape fields, stamped on the navigate-to-reports ContentLoad span.
        ATTRIBUTE_SEARCH_CALL_OFFSET_MS: 'search_call_offset_ms',
        ATTRIBUTE_SEARCH_WAIT_FOR_WRITES_MS: 'search_wait_for_writes_ms',
        ATTRIBUTE_SEARCH_REQUEST_MS: 'search_request_ms',
        ATTRIBUTE_SEARCH_SERVER_RESPONSE_MS: 'search_server_response_ms',
        ATTRIBUTE_SEARCH_OFFSET: 'search_offset',
        ATTRIBUTE_SEARCH_JSON_CODE: 'search_json_code',
        ATTRIBUTE_SEARCH_HAS_MORE_RESULTS: 'search_has_more_results',
        ATTRIBUTE_SEARCH_RESULT_DATA_KEYS: 'search_result_data_keys',
        ATTRIBUTE_SEARCH_RESULT_REPORTS_COUNT: 'search_result_reports_count',
        ATTRIBUTE_SEARCH_RESULT_TRANSACTIONS_COUNT: 'search_result_transactions_count',
