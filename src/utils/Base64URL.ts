...
const Base64URL = {
    ...
    decode: (value: Base64URLString) => {
        // 1. Replace URL-safe characters back to Base64 standard characters
        let base64 = value.replaceAll('-', '+').replaceAll('_', '/');

        // 2. Add padding characters '=' based on the length modulo 4
        ...
        // 3. Convert the base64 string back to bytes
