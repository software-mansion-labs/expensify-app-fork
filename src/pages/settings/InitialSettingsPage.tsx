        ...
        return {
            ...
            items: [
                ...
                },
                {
                    ...
                    shouldShowRightComponent: hybridApp?.oldDotSignInState === CONST.HYBRID_APP_SIGN_IN_STATE.RETRYING_AFTER_FAILURE,
                    disabled: hybridApp?.oldDotSignInState === CONST.HYBRID_APP_SIGN_IN_STATE.RETRYING_AFTER_FAILURE,
                    rightComponent: (
                    ...
                    {menuItemsData.items.map((item) => {
                        ...
                        return (
                            <MenuItem
                                ...
                                disabled={isExecuting || item.disabled}
    ...
    return (
        ...
        >
            ...
            >
                ...
                <ConfirmModal
                    success
                    title="Aw shucks. Error"
                    prompt="There was a problem switching to Expensify Classic. Try again later"
